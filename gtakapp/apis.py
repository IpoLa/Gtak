...
from gtakapp.models import Restaurant, Meal, Order, OrderDetails
from gtakapp.serializers import RestaurantSerializer, MealSerializer, OrderSerializer

import stripe
from Gtak.settings import STRIPE_API_KEY
